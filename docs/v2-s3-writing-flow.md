...
|---------|------|----------|
| 均衡万用、自然流畅 | 云墨 | 万用（默认） |
| 冷峻简约、短句、白描、动作化叙事 | 剑心 | 武侠、仙侠 |
| 精确、技术感、理性叙述 | 星河 | 硬科幻、太空 |
| 温暖细腻、长句、情感细写、氛围渲染 | 素手 | 日常、言情 |
| 市井烟火气、口语化、快节奏 | 烟火 | 现代、都市 |
| 层层递进、信息控制、悬念留白 | 暗棋 | 推理、悬疑 |
| 典雅庄重、文白混用、时代语感 | 青史 | 朝堂、历史 |
| 压抑、感官描写密集、心理暗示 | 夜阑 | 惊悚、恐怖 |
| 轻快、节奏明快、反差幽默 | 谐星 | 轻松、喜剧 |
