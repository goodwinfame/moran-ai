...
| 剑心 | 寒刃白描 | 冷峻简约、短句、白描、动作化叙事 | Kimi K2 |
| 星河 | — | 精确、技术感、理性叙述 | GPT-4o |
| 素手 | 暖阳絮语 | 温暖细腻、长句、情感细写、氛围渲染 | Claude Opus |
| 烟火 | — | 市井烟火气、口语化、快节奏 | GPT-4o |
| 暗棋 | 迷雾潜行 | 层层递进、信息控制、悬念留白 | Claude Opus |
| 青史 | 苍穹长歌 | 典雅庄重、文白混用、时代语感 | Claude Opus |
| 夜阑 | 暗夜低吟 | 压抑、感官描写密集、心理暗示 | Gemma4 |
| 谐星 | 嬉笑怒骂 | 轻快、节奏明快、反差幽默 | GPT-4o |

> 显示别名为可选的诗意名称，用于 UI 展示（如"执笔·寒刃白描"）。无别名的子写手以子名展示（如"执笔·云墨"）。
...
| Spec 编写 | ⏳ 待开始 | 按模块写 SPEC/DESIGN/TASKS |
